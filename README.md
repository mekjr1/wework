## We Work Meteor
https://www.jobar.co.mz/
# Devs Job Board and Developer Directory
...
## Settings
This app does need a settings file to run - see `settings-example.json` for the supported values.  The actual settings used for jobar.co.mz are kept private
