RssFeed.publish('jobs', function(query) {
  ...
  self.setValue('title', self.cdata('Jobar - Recent Jobs'));
  self.setValue('description', self.cdata('This is a feed of recent jobs posted to Jobar.'));
...
var profileRss = function(query) {
  ...
  self.setValue('title', self.cdata('Jobar - Recent Profiles'));
  self.setValue('description', self.cdata('This is a feed of recent profiles listed on Jobar.'));
  self.setValue('link', Meteor.absoluteUrl());
  self.setValue('lastBuildDate', lastBuildDate);
  self.setValue('pubDate', pubDate);
  self.setValue('ttl', 1);
